    ...
    with open("LogInvalidLogin.txt", "r") as newFile:
        ...
        if "FAIL" in content:
            ...
            with open(r"D:\ProjectCourseQA\FinalResults.txt", "a") as file:
                file.write(f"\n{datetime.now()}" + " Test Case 03: The InvalidLoginPassword Test Case FAILED!")
        else:
            print("Test Case - 03 PASSED!")
            with open(r"D:\ProjectCourseQA\FinalResults.txt", "a") as file:
                file.write(f"\n{datetime.now()}" + " Test Case 03: The InvalidLoginPassword Test Case PASSED!")
except:
